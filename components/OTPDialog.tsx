  ...
  return (
    <div className="w-[99vw] flex justify-center items-center h-[90vh]">
      <Dialog>
        <div
          className={`${
            showResetPassword ? "hidden" : "block"
          } sm:max-w-sm !rounded-xl p-6 border`}
        >
      ...
      >
        ...
        />
        <button
          className="p-2 bg-blue-600 rounded-lg text-white mt-3 ms-[64%]"
