...
export function CarDetail() {
  ...
  return (
    <div className="lg:max-w-7xl mx-auto lg:px-4 px-2">
      ...
      {locationOpen && <LocationForm open={locationOpen} setOpen={setLocationOpen} page='Model'/>}
      {loading ? (
        <CarLoadingComponent/>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className='flex gap-2 my-4 overflow-x-auto scrollbar-hide snap-x snap-mandatory pb-2'>
          ...
          <button 
            onClick={() => {setSelectedTab('price'); router.push(`${car.modelName}/${'price-in-'+capitalizeString(localStorage.getItem('caarzyLocation') || '').replace(/\s+/g, '')}`)}} 
          ...
          <button 
            onClick={() => {setSelectedTab('images'); router.push(`${car.modelName}/images`)}} 
        ...
        <div className='flex text-muted-foreground items-center gap-4 px-4'>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4 text-sm mt-8">
      ...
      <div className="grid mt-4 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-20">
        {blogs.map((blog: any, index: number) => (
          <div key={index} className='lg:w-[400px] h-[436px]'>
            <div className='w-full md:h-[250px] h-[200px] relative rounded-2xl overflow-hidden'>
