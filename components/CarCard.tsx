...
export function CarCard({car}: CarCardProps) {
  ...
  const router = useRouter();
    ...
    //     {/* Specifications */}
    //     <div className="flex gap-2 items-center space-y-1 mb-4">
    ...
    //           <span className='w-14'>{car?.variant[0]?.engineAndTransmission?.Range?.split(' ')[0] || 'NA'} km</span>
    //         ) : (
    //           <span className='w-16'>{car?.variant[0]?.fuelAndPerformance?.petrolMileageARAI.split(' ')[0] || 'NA'} km</span>
    //         )}
    //       </div>
    //       <div className="flex items-center gap-1 text-sm text-gray-600">
    //         <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
     ...
     <div key={car.modelName}
            ...
            <div className="relative aspect-video overflow-hidden bg-secondary">
              ...
              <div className="absolute bottom-2 left-2 px-2 py-0.5 rounded-lg text-xs font-black main-text-color" style={{ background: "hsl(var(--accent))" }}>
                {car.launchDate ? new Date(car.launchDate).getFullYear() : 'NA'}
              </div>
            </div>
            {/* Info */}
            <div className="p-4">
