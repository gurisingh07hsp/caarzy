...
export function CarCard({ car}: CarCardProps) {
  ...
  // const originalPrice = car.originalPrice;
    ...
    return (
      ...
      <div className="p-4">
        {/* Category */}
        <p className="text-orange-500 text-sm font-medium mb-2">{car.bodyType === 'suv' ? 'SUV' : car.category.charAt(0).toUpperCase() + car.category.slice(1)}</p>
        
        {/* Car Name */}
        <h3 className="text-lg font-bold text-gray-900 mb-3">{car.brand.charAt(0).toUpperCase() + car.brand.slice(1)} {car.modelName.charAt(0).toUpperCase() + car.modelName.slice(1)}</h3>
