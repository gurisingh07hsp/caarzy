...
export function HeroSection({ searchTerm, onSearchChange }: HeroSectionProps) {
  ...
  return (
    <div className="bg-white max-w-7xl mx-auto mt-2">
      {/* Hero Background */}
      <div className='relative h-[530px] w-full'>
        ...
        <div className='relative ms-4 w-max'>
          ...
          <div className='w-12 h-36 bg-white absolute top-72 right-0 rotate-45'></div>
          <div className='w-[70%] flex h-40 absolute bottom-0 right-0'>
            <div className='relative w-full h-full flex'>
              <div className='h-36 w-9 bg-white rotate-[15deg] rounded-xl'></div>
              <div className='w-full h-full absolute left-5 bg-white rounded-t-lg'>
                <div className='mt-8 ms-6 flex justify-between'>
                  <div className='max-w-80'>
                    <h1 className='text-4xl'>Quality <b className='text-[#FF3F25]'>Cars</b> with <b className='text-[#FF3F25]'>Unbeatable</b> Deals</h1>
                  </div>
                  <div>
                    <div className='max-w-36 text-sm text-[#595959]'>We help you find the right car.</div>
                    <div className='text-xs mt-5'>4.9 star rating</div>
                  </div>
                </div>
              </div>
            </div>
