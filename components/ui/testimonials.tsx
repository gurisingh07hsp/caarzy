...
const carTestimonials = [
  {
    text: "“Caarzy made comparing cars incredibly simple. I could check on-road prices, mileage, colors, and features all in one place without any confusion.”",
    name: "Rahul Sharma",
  },
  {
    text: "“The website is very clean and easy to use. I compared multiple car variants side by side and quickly found the best option for my budget.”",
    name: "Priya Verma",
  },
  {
    text: "“I loved the detailed car information on Caarzy. The mileage, specifications, and price breakdown helped me make a confident decision before visiting the dealership.”",
    name: "Aman Singh",
  },
  {
    text: "“Caarzy saved me so much time. Instead of checking multiple websites, I found everything from colors to on-road prices instantly.”",
    name: "Neha Kapoor",
  },
  {
    text: "“One of the best car comparison platforms I’ve used. The interface is smooth, modern, and very user-friendly.”",
    name: "Arjun Mehta",
  },
  {
    text: "“The real-time pricing and variant comparison features are excellent. Caarzy makes car research fast, simple, and stress-free.”",
    name: "Sneha Patel",
  }
];
