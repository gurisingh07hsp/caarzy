...
export function ContactPage() {
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <h1 className="text-3xl text-center font-bold text-slate-900 mb-4">Contact Us</h1>
      <div className='flex md:flex-row flex-col gap-8 mt-16'>
        <div>
          <div>
            <h2 className='text-xl font-medium'>Drop Us a Line</h2>
            <p className='text-[#747170] text-sm mt-2'>Feel free to connect with us through our online channels for updates, news, and more.</p>
          </div>
          <div className='grid grid-cols-2 gap-4 mt-2'>
            <div className=''>
              <p>Name</p>
              <input type="text" placeholder='Your Name' className='border px-4 py-2 w-full rounded-lg' />
            </div>
            <div>
              <p>Email Address</p>
              <input type="text" placeholder='Your Email' className='border px-4 py-2 w-full rounded-lg' />
            </div>
            <div>
              <p>Phone Number</p>
              <input type="text" placeholder='Phone Number' className='border px-4 py-2 w-full rounded-lg' />
            </div>
            <div>
              <p>Subject</p>
              <input type="text" placeholder='Enter Keyword' className='border px-4 py-2 w-full rounded-lg' />
            </div>
          </div>
        ...
        <div className='border rounded-2xl shadow-md p-7'>
          ...
          <div className='mt-4'>
            ...
            <p className='text-[#747170] text-sm'>101 E 129th St, East Chicago, IN 46312 United States</p>
          </div>
          <div className='mt-4'>
            <p className='font-medium'>Infomation:</p>
            <p className='text-[#747170] text-sm'>1-333-345-6868</p>
            <p className='text-[#747170] text-sm'>themesflat@gmail.com</p>
          </div>
          <div className='mt-4'>
            <p className='font-medium'>Opentime:</p>
            <p className='text-[#747170] text-sm'>Monay - Friday: 08:00 - 20:00</p>
            <p className='text-[#747170] text-sm'>Saturday - Sunday: 10:00 - 18:00</p>
          </div>
        <div>
          <h2 className='text-lg font-medium mt-4'>Follow Us:</h2>
          <div className='flex gap-2 mt-1'>
            <div className='w-9 h-9 rounded-md border flex justify-center items-center'>
              <svg width="10" height="18" viewBox="0 0 10 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M9.00879 10.125L9.50871 6.86742H6.38297V4.75348C6.38297 3.86227 6.81961 2.99355 8.21953 2.99355H9.64055V0.220078C9.64055 0.220078 8.35102 0 7.11809 0C4.54395 0 2.86137 1.56023 2.86137 4.38469V6.86742H0V10.125H2.86137V18H6.38297V10.125H9.00879Z" fill="#B6B6B6"/>
              </svg>
            </div>
